...
React JS is a way to create complex single-page applications much easier than by just using HTML, CSS and JS. It gives you the ability to create components which can be reused however many times you want and helps with DRY coding practices.

- [X] What does it mean to _think_ in react?

Thinking in React is a way of thinking of applications by components instead of one whole. How can you break the webpage down into the most reusable components that you can and then you put those components together to create one cohesize page.

- [X] Describe state.

State is kind of like a specific memory of the page, and the page knows that when a specific event happens it triggers all of these changes and so on. It is a way to make more fluid user interactive pages.

- [X] Describe props.

Props are the pieces of data that get passed from component to component to make sure all of the correct information is getting displayed where it needs to be.
